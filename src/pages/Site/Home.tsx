      ...
      <section className="py-16 bg-gray-light">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3].map(item => <div key={item} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                <div className="h-48 bg-blue-trust bg-opacity-10"></div>
                <div className="p-6">
                  <div className="flex items-center text-green-hope mb-2">
                    <CalendarIcon className="w-4 h-4 mr-2" />
                    <span className="text-sm">15 de Novembro, 2025</span>
                  </div>
                  <h3 className="font-montserrat text-xl font-semibold mb-2">
                    Evento de Conscientização
                  </h3>
                  <p className="text-gray-600 mb-4">
                    Palestra sobre prevenção e tratamento de dependência química
                    para familiares e interessados.
                  </p>
