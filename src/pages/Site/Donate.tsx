...
import qrcode_pix from '../../assets/qrcode-pix.jpeg'
import { BanknoteIcon, ShoppingBagIcon, HeartIcon, PhoneIcon, HeartHandshake, HandHeartIcon } from 'lucide-react';
const Donate = () => {
              ...
              {donationType === 'financial' ? <div className="text-center">
                ...
                <div className="bg-white p-6 rounded-lg mb-6 flex flex-col items-center">
                  <div className="bg-white p-3 rounded-lg shadow-sm mb-4">
                    <img src={qrcode_pix} alt="QR Code PIX" className="w-48 h-48 mx-auto" />
                  </div>
                ...
                <div className='flex justify-between'>
                  <div
                    className="bg-blue-trust p-4 rounded-md w-[48%] text-center text-white hover:cursor-pointer"
                    onClick={() => window.open("https://www.asaas.com/c/766876524386", "_blank")}
                  >
                    <HeartHandshake className='ml-auto mr-auto w-[64px] h-[64px]'></HeartHandshake>
                    <h1>Realize doações mensais automaticamente <p></p> <span className='text-slate-300'>(Clique aqui)</span></h1>
                  </div>
                  <div
                    className="bg-blue-trust p-4 rounded-md w-[48%] text-center text-white hover:cursor-pointer"
                    onClick={() => window.open("https://www.asaas.com/c/764532884896", "_blank")}
                  >
                    <HandHeartIcon className='ml-auto mr-auto w-[64px] h-[64px]  '></HandHeartIcon>
                    <h1>Realize uma doação avulsa <p></p> <span className='text-slate-300'>(Clique aqui)</span></h1>
                  </div>
                </div>
              </div> : <div>
                <h3 className="font-montserrat text-xl font-semibold text-blue-trust mb-4">
